...
-   A list of things that _fit_ the logic of freed markets and push in that direction.
...
1. Change how we see the world (story & understanding).
2. Build counter-institutions that live a bit of the freed-market logic now.
3. Fight for harm reduction inside the existing system.
...
-   Spreading the core distinction:
...
-   Helping people see the four monopolies in their own lives:
...
That may sound small, but systems almost never change if most people can’t even _name_ what’s happening to them.
...
-   You are not responsible for “winning.”  
    You are responsible for choosing what to cooperate with.
    -   You can choose not to parrot the story that this is the best we can do.
